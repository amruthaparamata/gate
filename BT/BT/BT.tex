...
\begin{align}
\implies \pr{Y > X \mid X = x} = \frac{11 - x}{10}
\end{align}
\begin{align}
\therefore \pr{Y > X} = \sum_{x=1}^{10} \frac{11 - x}{10} \cdot \frac{1}{10}
\end{align}
\begin{align}
\pr{Y > X} = 0.55
\end{align}
Therefore, the probability that the number on the second draw is greater than the number on the first draw is approximately $0.55$ or $55\%$.
\end{document}
